-- Safe fix for TopCityTickets production issues
-- This version handles existing policies better
-- Run this in Supabase SQL Editor

-- 1. Add missing columns to events table (safe)
...
-- 2. Add missing columns to users table for better functionality (safe)
...
-- 4. Create or replace trigger functions for updated_at (safe)
...
-- 5. Add triggers for updated_at columns (safe)
...
-- 6. Enable RLS on all tables (safe)
...
-- 7. COMPREHENSIVE DROP of ALL possible existing policies
...
-- 8. Create NEW comprehensive RLS policies for users table
...
-- 9. Create NEW RLS policies for events table
...
-- 10. Create NEW RLS policies for seller_applications table
...
-- 11. Create NEW RLS policies for tickets table
...
-- 12. Create NEW RLS policies for event_submissions table
...
SELECT 
    'Schema update complete - check your admin dashboard and seller applications now!' as final_message;
